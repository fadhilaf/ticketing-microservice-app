...
export abstract class CustomError extends Error {
  ...
  constructor(message: string) {
    ...
    super(message); // constructor dari derived class harus panggil constructor dari parent classny dulu (super()), biar galo galo properti dari parent classny dituruni ke class ini
